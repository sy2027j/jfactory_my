                  ...
                  <div class="myForm-group">
                     ...
                     <div class="form-group" id="checkboxes">
                        <div>
                           ...
                           <button type="button" class="btn btn-default"
                              onclick="window.open('join_agree1','_blanck','width=450, height=650'); return false"
                              style="border-color: white; background-color: #e6e6fa; color: black;">내용보기</button>
                        </div>
                        <div>
                           <input type="checkbox" name="check2" id="check2"> <b>개인정보
                              수집 및 이용 동의</b>&nbsp;<font color="red">(필수)</font>&nbsp;
                           <button type="button" class="btn btn-default"
                              onclick="window.open('join_agree2','_blanck','width=450, height=650'); return false"
                              style="border-color: white; background-color: #e6e6fa; color: black;">내용보기</button>
                        </div>
                        <div>
                           <input type="checkbox" name="check3" id="check3" value="1">
                           <b>만 14세 이상입니다.</b>&nbsp;<font color="red">(필수)</font>
                           <p style="font-size: 13px">만 19세 미만의 미성년자가 결제 시 법정대리인이 거래를
                              취소할 수 있습니다.
                           <p>
                        </div>
                     </div>
