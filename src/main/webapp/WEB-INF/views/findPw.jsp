...
<br/><br/>   
  ...
  <div class="row">
                <div id="header">
      <div id="wrapper">
        <form id="signUp" method="post" action="findPw">
		<h3 class="contents" style="text-align:center">비밀번호 찾기</h3>
		...
		<div class="form-group">
			...
			<div class="form-group">
				<label for="MEMBER_NAME">아이디 *</label> <input type="text"
					class="form-control" id="mem_id" name="mem_id" style="width:470px;"
			...
			<div align="center">
			<button style="border-color:white; background-color:#e6e6fa; color:black; WIDTH: 80pt; HEIGHT: 30pt" type="submit" class="btn center" onclick="location.href='setPw'">확인</button>
