...
<br/><br/>   
  ...
  <div class="row">
                <div id="header">
      <div id="wrapper">
        <form id="findPw" method="post" action="findPw">
      ...
      <div class="form-group">
         ...
         <div align="center">
         <button style="border-color:white; background-color:#e6e6fa; color:black; WIDTH: 80pt; HEIGHT: 30pt" type="submit" class="btn center" onclick="findPw_chk();">확인</button>
