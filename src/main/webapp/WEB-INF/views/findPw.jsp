      ...
      <div id="wrapper">
		...
		<div class="form-group">
				<label for="MEMBER_NAME">이름 *</label> <input type="text"
					class="form-control" id="MEMBER_NAME" name="MEMBER_NAME" style="width:470px;"
			...
			<div align="center">
			<button style="border-color:white; background-color:#e6e6fa; color:black; WIDTH: 80pt; HEIGHT: 30pt" type="button" class="btn center" onclick="location.href='setPw'">확인</button>
