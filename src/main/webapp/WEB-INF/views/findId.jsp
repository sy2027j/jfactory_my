  ...
  <div class="row">
      ...
      <div id="wrapper">
		...
		<div class="myForm-group">
			...
			<div align="center">
			<button style="border-color:white; background-color:#e6e6fa; color:black; WIDTH: 80pt; HEIGHT: 30pt" type="button" class="btn center" onclick="location.href='showId'">확인</button>
