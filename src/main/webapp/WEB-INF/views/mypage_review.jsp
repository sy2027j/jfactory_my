		...
		<div class="mypage_top container">
			...
			<div>
				<ul class="sidenav_list">
					<li><a class="current" href="mypage_orderlist">주문내역</a></li>
		...
		<div class="review container">
			...
			<div class="container col-lg-9">
				<section class="contents">
					<h2 class="subTitle3">내가 작성한 리뷰</h2>
				</section>
			</div>

			<div class="reviewlist container col-lg-7">
				<table class="table" id="reviewlisttable">
					<thead class="table-header-bg" style="background-color: #e6e6fa">
						<tr>
							...
							<th style="width: 8%;"><center>작성날짜</center></th>
							<th style="width: 8%;"><center>별점</center></th>
							<th style="width: 8%;"><center>조회수</center></th>
						</tr>
					</thead>
					<tbody id="review" class="table-body-row">
						<tr th:each="result : ${reviewListResult}">
							<td class="product_choice" style="vertical-align: middle;"
								th:text="${result.viewNum}"><center>1</center></td>
							<td class="product_img" style="vertical-align: middle;"
								th:text="${result.viewproductNumber}"><center>
