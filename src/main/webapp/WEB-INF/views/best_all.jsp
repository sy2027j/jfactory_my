...
<hr>
  ...
  <div class="container">
    ...
    <c:forEach items="${bestlist}" var="bestlist">
      <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item" onclick="location.href='product_detail?pd_name=${bestlist.getPd_name()}&pd_category=${bestlist.getPd_category() }'">
